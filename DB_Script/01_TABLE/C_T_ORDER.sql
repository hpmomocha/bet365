CREATE TABLE `t_order` (
  ...
  `is_win` varchar(1) DEFAULT '0' COMMENT '是否中奖',
  `is_closed` varchar(1) DEFAULT '0' COMMENT '是否结算完成',
  `is_closed_manually` varchar(1) DEFAULT '0' COMMENT '是否手动完成结算',
  `order_date` varchar(10) NOT NULL COMMENT '投注日期',
