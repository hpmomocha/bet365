CREATE TABLE `t_m_match_country` (
  ...
  CONSTRAINT `fk_match_country_global_match` FOREIGN KEY (`cy_belongs_in_gbl_match_id`) REFERENCES `t_m_global_match` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='赛事国家一览表'